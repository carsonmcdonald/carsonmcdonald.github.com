...
//
// Find out more about short links here:
// https://developer.apple.com/library/ios/#qa/qa1633/_index.html
//

function applyRules(inputValue)
{
  // 1. Remove all whitespace
  var workingValue = inputValue.replace(/\s+/g, ''); 
  ...
  workingValue = workingValue.toLowerCase(); 
...
function createLink()
{
  var displayValue = 'http://appstore.com/';

  var companyValue = document.getElementById('company').value;
  var appnameValue = document.getElementById('appname').value;

  var apptypeValue = 'ios';
  var apptypeInput = document.getElementsByName('apptype');
  for(var i = 0; i < apptypeInput.length; i++) 
  {
    if(apptypeInput[i].checked) 
    {
      apptypeValue = apptypeInput[i].value;
    }
  }
  ...
  if(companyValue != '')
  {
    displayValue += applyRules(companyValue) + (appnameValue != '' ? '/' : '');
  }

  if(appnameValue != '')
  {
    displayValue += applyRules(appnameValue);
  }

  document.getElementById('result').innerHTML = '<a href="' + displayValue + '">' + displayValue + '</a>';
}
